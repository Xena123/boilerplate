...
module.exports = {
	...
	// JS Vendor options.
	jsVendorSRC: './assets/vendor/*.js', // Path to JS vendor folder.
	jsVendorDestination: './assets/dist/vendorjs/', // Path to place the compiled JS vendors file.
	...
	watchJsVendor: './assets/vendor/*.js', // Path to all vendor JS files.
